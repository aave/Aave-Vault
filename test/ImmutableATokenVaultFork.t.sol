...
contract ImmutableATokenVaultForkTest is ImmutableATokenVaultForkBaseTest {
    ...
    function testCannotInitImpl() public {
        _deploy(address(dai), POLYGON_POOL_ADDRESSES_PROVIDER);
        vm.expectRevert(ERR_INITIALIZED);
        vault.initialize(OWNER, fee, SHARE_NAME, SHARE_SYMBOL, 0);
    }

    function testConstructorReverts_ZeroOwner() public {
    ...
    function testConstructorReverts_ZeroInitialDeposit() public {
    ...
    function testConstructorReverts_FeeTooHigh() public {
    ...
    function testInitWithInitialDeposit() public {
        ...
        dai.approve(vaultAddress, amount);
    ...
    function testDeployEmitsFeeEvent() public {
        ...
        address vaultAddress = computeCreateAddress(address(this), vm.getNonce(address(this)) + 1);
        dai.approve(vaultAddress, initialLockDeposit);
